...
describe(RSSCache::Feed::Item) do
  ...
  it "can provide an RSS item's id" do
  ...
  it "can provide an Atom item's guid" do
  ...
  it "can provide an RSS item's title" do
  ...
  it "can provide an Atom item's title" do
  ...
  it "can provide an RSS item's author" do
  ...
  it "can provide an Atom item's author" do
  ...
  it "can provide an RSS item's link" do
    expect(@rss_items[0].link).to be_a String
  end

  it "can provide an Atom item's link" do
    expect(@atom_items[0].link).to be_a String
  end

  it "can provide an RSS item's published date" do
    expect(@rss_items[0].published).to be_a Time
  end

  it "can provide an Atom item's published date" do
    expect(@atom_items[0].published).to be_a Time
  end

  it "can provide an RSS item's updated date" do
    expect(@rss_items[0].updated).to be_a Time
  end

  it "can provide an Atom item's updated date" do
    expect(@atom_items[0].updated).to be_a Time
  end

  it "can provide an RSS item's description" do
    expect(@rss_items[0].description).to be_a String
  end

  it "can provide an Atom item's summary" do
    expect(@atom_items[0].summary).to be_a String
  end

  it "can provide an RSS item's description as contents" do
  ...
  it "can provide an Atom item's contents" do
  ...
  it "can provide an RSS feed's comments link" do
  ...
  it "can provide empty string as Atom feed's comments link" do
